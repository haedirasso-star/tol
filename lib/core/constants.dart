...
class C {
  ...
  static const telegram = Color(0xFF229ED9); // Telegram blue
...
class CC {
  ...
  static const textPri  = Color(0xFFF2EDEA);
  ...
  static const white    = Color(0xFFF2EDEA);
}
...
class CExtra {
  ...
  static const border   = Color(0xFF2E2B27); // border (same as C.border)
  static const heroGrad = LinearGradient(
    begin: Alignment.topCenter, end: Alignment.bottomCenter,
    stops: [0.0, 0.4, 1.0],
    colors: [Color(0x000F0E0D), Color(0x880F0E0D), Color(0xFF0F0E0D)],
  );
}
...
extension TExtra on T {
  ...
  static TextStyle h1({Color c = const Color(0xFFF2EDEA), double s = FS.x2l}) =>
      TextStyle(fontFamily: _cairo, fontSize: s, fontWeight: FontWeight.w800, color: c, letterSpacing: -0.5);

  // h2 — section headings
  static TextStyle h2({Color c = const Color(0xFFF2EDEA), double s = FS.lg}) =>
      TextStyle(fontFamily: _cairo, fontSize: s, fontWeight: FontWeight.w700, color: c);

  // display — hero/cinematic large title
  static TextStyle display({Color c = const Color(0xFFF2EDEA), double s = FS.x3l}) =>
  ...
  static TextStyle label({Color c = const Color(0xFFF2EDEA), double s = FS.xs,
  ...
  static TextStyle cinzel({double s = FS.lg, Color c = const Color(0xFFF2EDEA),
      FontWeight w = FontWeight.w700}) =>
      GoogleFonts.cinzelDecorative(fontSize: s, fontWeight: w, color: c);

  // num — numbers & stats
  static TextStyle num({double s = FS.lg, Color c = const Color(0xFFF2EDEA),
      FontWeight w = FontWeight.w700}) =>
