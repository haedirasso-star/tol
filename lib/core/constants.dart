...
// ════════════════════════════════════════════════════════════════
// ════════════════════════════════════════════════════════════════
//  SubCompat — Compatibility wrapper for Sub
//  مُوحِّد للوصول إلى بيانات الاشتراك من كل مكان
// ════════════════════════════════════════════════════════════════
class SubCompat {
  // ── Subscription status ─────────────────────────────────────
  static bool get isPremium  => Sub.isActive && (Sub.plan == Sub.kPremium || Sub.plan != Sub.kFree);
  static bool get isNormal   => Sub.isActive;
  static bool get isTOTV     => Sub.username.isNotEmpty && Sub.password.isNotEmpty;

  // ── Credentials ──────────────────────────────────────────────
  static String get xtreamUser => Sub.username.isNotEmpty ? Sub.username : RC.username;
  static String get xtreamPass => Sub.password.isNotEmpty ? Sub.password : RC.password;
  static String get xtreamBase => Server.baseUrl;
