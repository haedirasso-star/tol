    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Navigator.pop(context)),
        title: Text('تتبع الطلبات', style: T.cairo(s: 16, w: FontWeight.w700)),
      ),
        ...
        builder: (ctx, snap) {
          ...
          if (docs.isEmpty) {
            return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('لا توجد طلبات بعد', style: T.cairo(s: 15, w: FontWeight.w600)),
              const SizedBox(height: 6),
                  ...
                  Row(children: [
                    ...
                    Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                      ...
                      child: Text(_statusLabel(status),
                          style: T.cairo(s: 11, c: _statusColor(status), w: FontWeight.w700))),
                  ]),
                    ...
                    Container(padding: const EdgeInsets.all(10),
                      ...
                      child: Row(children: [
                        ...
                        Text('تم تفعيل اشتراكك بنجاح 🎉',
                            style: T.cairo(s: 11, c: const Color(0xFF4CAF50))),
                      ])),
                  ],
                ]));
            });
