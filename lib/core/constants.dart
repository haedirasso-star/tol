...
// ════════════════════════════════════════════════════════════════
class RC {
  static FirebaseFirestore get _db => FirebaseFirestore.instance; // ★ lazy - not static final
...
// ════════════════════════════════════════════════════════════════
class Server {
  // ★ النظام الجديد: لا سيرفر افتراضي إطلاقاً.
  //   المحتوى يأتي حصراً من سيرفر المستخدم الخاص (host + user + pass).
  static String get host {
    return Sub.host.replaceAll(RegExp(r'/$'), '');
  }
...
class Sub {
  ...
  // ★ النظام الجديد: هل لدى المستخدم سيرفر خاص كامل (host+user+pass)؟
  static bool      get hasServer =>
      _host.isNotEmpty && _username.isNotEmpty && _password.isNotEmpty;
