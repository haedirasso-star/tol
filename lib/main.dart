...
//  6. MobileAds.initialize()     ← قبل runApp لمنع FATAL EXCEPTION
...
Future<void> main() async {
  ...
  // ══ 6. MobileAds ═══════════════════════════════════════════════
  // يجب قبل runApp — غيابه يُسبب FATAL EXCEPTION في بعض الأجهزة
  if (!kIsWeb) {
    try {
      await MobileAds.instance.initialize()
          .timeout(const Duration(seconds: 5));
    } catch (e) { debugPrint('[main] AdMob (non-fatal): $e'); }
  }
