  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        useMaterial3: true,
        scaffoldBackgroundColor: const C.bg, // أعمق وأكثر سينمائية
        colorScheme: ColorScheme.dark(
          primary:    const C.gold,
          secondary:  const C.goldDim,
          surface:    const C.surface,
          onSurface:  Colors.white,
          surfaceContainerHighest: const C.card,
        ),
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          GestureDetector(
            ...
            child: Container(width: double.infinity, height: 50,
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [C.gold, C.goldDim]),
          ...
          TextButton(
            ...
            child: Text('تواصل مع الدعم', style: GoogleFonts.cairo(fontSize: FS.md, color: const C.whatsapp))),
        ]))));
  }
}
