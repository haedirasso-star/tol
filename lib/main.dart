// ════════════════════════════════════════════════════════════════
//  TOTV+ — main.dart  (FIXED v2)
//  الإصدار يُقرأ دائماً من pubspec.yaml عبر PackageInfo
//  مصدر البيانات الوحيد: Xtream server من Firestore
// ════════════════════════════════════════════════════════════════
...
Future<void> main() async {
  ...
  // ① قراءة الإصدار الحقيقي من pubspec.yaml
...
class _AppState extends State<App> {
  ...
  void initState() {
    super.initState();
    RC.onConfigChanged  = () { if (mounted) setState(() {}); };
    RC.onVersionChanged = () { if (mounted) setState(() {}); };

    // ★ FIX 1+2: إذا كان المستخدم مسجّلاً دخوله مسبقاً،
    // ابدأ مستمع Firestore فوراً لضمان مزامنة isAdmin والاشتراك
