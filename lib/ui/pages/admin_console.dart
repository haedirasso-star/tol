        ...
        if(receipt.isNotEmpty)...[
          ...
          GestureDetector(onTap:()=>showDialog(context:context,builder:(_)=>Dialog(backgroundColor:Colors.transparent,
            ...
            child:Stack(children:[
              InteractiveViewer(minScale:0.5,maxScale:5,
                child:ClipRRect(borderRadius:BorderRadius.circular(12),child:Image.network(receipt))),
            ...
            child:ClipRRect(borderRadius:BorderRadius.circular(10),
              child:Stack(children:[
                Image.network(receipt,height:150,width:double.infinity,fit:BoxFit.cover,
                  loadingBuilder:(_,child,prog)=>prog==null?child:Container(height:150,color:_AC.bg3,
                    child:const Center(child:CircularProgressIndicator(strokeWidth:2,color:_AC.gold))),
                  errorBuilder:(_,__,___)=>Container(height:70,color:_AC.bg3,
