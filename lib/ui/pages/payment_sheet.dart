...
class _PayPaymentSheetState extends State<_PayPaymentSheet> {
  ...
  Future<void> _pickReceipt() async {
    Sound.hapticL();
    if (!kReceiptUploadInApp) {
      // المسار الافتراضي بلا حزم إضافية: تحويل لواتساب
      final wa = RC.whatsapp.replaceAll('+', '');
    ...
    // ── المسار الكامل (فعّله بعد إضافة image_picker + firebase_storage) ──
    /*
