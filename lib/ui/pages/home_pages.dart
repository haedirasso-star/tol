...
class _HomePageState extends State<HomePage> with AutomaticKeepAliveClientMixin {
  ...
  // ── حالة: لا سيرفر متصل — اتصل بسيرفرك ────────────────
      ...
      body: SafeArea(child: Center(child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(width: 92, height: 92,
            decoration: BoxDecoration(
              color: C.gold.withOpacity(0.10), shape: BoxShape.circle,
              border: Border.all(color: C.gold.withOpacity(0.35), width: 1.5)),
            child: const Icon(Icons.dns_rounded, color: C.gold, size: 44)),
          const SizedBox(height: 22),
          Text('لا يوجد سيرفر متصل',
            style: T.cairo(s: FS.xl, w: FontWeight.w900, c: C.textPri)),
          const SizedBox(height: 10),
          Text('أدخل بيانات سيرفرك (الرابط واسم المستخدم وكلمة المرور)\nلعرض الأفلام والمسلسلات والقنوات الخاصة بك.',
            textAlign: TextAlign.center,
            style: T.cairo(s: FS.sm, c: C.textSec)),
          const SizedBox(height: 26),
          GestureDetector(
            onTap: () => VipLoginSheet.show(context),
            child: Container(height: 54,
              ...
              child: Center(child: Text('اتصل بسيرفرك',
