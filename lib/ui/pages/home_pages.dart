...
class _ActivateScreenState extends State<_ActivateScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final title = expired ? 'تم إنهاء الاشتراك'
        : isPremium ? 'فعّل سيرفرك' : 'فعّل اشتراكك';
    final subtitle = expired
        ? 'انتهت صلاحية اشتراكك. جدّد عبر واتساب أو من خطط الاشتراك.'
        : 'اكتب اسم المستخدم وكلمة المرور — يتصل بسيرفرك\nويحمّل محتواك ويحفظه تلقائياً.';
            ...
            GestureDetector(
              ...
              child: Container(height: 56, width: double.infinity,
                ...
                child: Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Icon(expired ? Icons.refresh_rounded : Icons.bolt_rounded, color: Colors.black, size: 21),
                  const SizedBox(width: 7),
                  Text(expired ? 'تجديد الاشتراك' : 'فعّل اشتراكك',
                    style: T.cairo(s: FS.md, w: FontWeight.w900, c: Colors.black)),
                ])))),
            const SizedBox(height: 11),
            // عرض الخطط (لغير المنتهي)
            if (!expired)
              GestureDetector(
                onTap: () => PayPlansSheet.show(context),
                child: Container(height: 50, width: double.infinity,
                  ...
                  child: Center(child: Text('عرض خطط الاشتراك',
