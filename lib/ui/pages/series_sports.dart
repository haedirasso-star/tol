        ...
        headerSliverBuilder: (_, __) => [
                  ...
                  Wrap(spacing: 6, children: [
                    if (rating.isNotEmpty && rating != '0.0')
                      Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Text(rating, style: TExtra.mont(s: 11, c: C.gold)),
                      ]),
                    Text('${seas.length} موسم', style: TExtra.mont(s: 11, c: C.grey)),
                  ]),
                ])),
              ]))),
          ])),
          ...
          if (plot.isNotEmpty)
            SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.fromLTRB(16,10,16,0),
              child: Text(plot, style: TExtra.mont(s: 12, c: C.grey), maxLines: 3,
                  overflow: TextOverflow.ellipsis))),
          // Cast
          if (cast.isNotEmpty)
          ...
          if (seas.length > 1)
            SliverToBoxAdapter(child: Container(
              ...
              child: TabBar(controller: tc, isScrollable: true,
                ...
                labelStyle: TExtra.mont(s: 12, w: FontWeight.w700),
                unselectedLabelStyle: TExtra.mont(s: 12),
                            ...
                            child: Stack(fit: StackFit.expand, children: [
                              ...
                              Positioned(bottom: 4, right: 4,
                                child: Container(padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 1),
                                  ...
                                  child: Text(n, style: TExtra.mont(s: 9, c: Colors.white, w: FontWeight.w600)))),
                            ]))),
                        const SizedBox(width: 12),
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          if (dur.isNotEmpty) ...[const SizedBox(height: 3),
                            Row(children: [const Icon(Icons.access_time_rounded, color: C.dim, size: 11),
                              const SizedBox(width: 3), Text(dur, style: TExtra.mont(s: 10, c: C.grey))])],
                          if (epPlot.isNotEmpty) ...[const SizedBox(height: 3),
                            Text(epPlot, style: TExtra.mont(s: 10, c: C.grey),
                                maxLines: 2, overflow: TextOverflow.ellipsis)],
                        ])),
...
class _SportsPageState extends State<SportsPage>
  ...
  // 3 providers only: beIN + الثامنة + Sky
          ...
          child: Stack(fit: StackFit.expand, children: [
            ...
            Positioned(bottom: 0, left: 0, right: 0,
              child: Container(
                ...
                child: Text(nm, style: T.caption(c: CC.textPri).copyWith(fontSize: 9, fontWeight: FontWeight.w600),
  ...
  Widget _buildHeader(double top) => Container(
    ...
    child: Row(children: [
      Container(width: 36, height: 36,
        decoration: BoxDecoration(color: CC.goldBg, borderRadius: BorderRadius.circular(10)),
      ...
      child: Row(children: [
        ...
        Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
          decoration: BoxDecoration(color: color.withOpacity(0.14),
              borderRadius: BorderRadius.circular(S.rPill)),
          child: Text('$count', style: TExtra.label(c: color, s: 10))),
      ]));
          ...
          child: Stack(fit: StackFit.expand, children: [
            ...
            Positioned(top: 6, left: 6,
              child: Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                decoration: BoxDecoration(color: CExtra.live, borderRadius: BorderRadius.circular(4)),
                child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              child: Stack(fit: StackFit.expand, children: [
                ...
                Positioned(top: 5, left: 5,
                  child: Container(padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 2),
                    ...
                    child: Text('LIVE', style: TExtra.label(c: Colors.white, s: 7)))),
                Positioned(bottom: 6, left: 6, right: 6,
                  child: Text(nm, style: T.caption(c: CC.textPri).copyWith(fontWeight: FontWeight.w600),
                      maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.right)),
              ]))));
          ...
          Row(children: [
            Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                if (match.isLive) ...[
                  ...
                  Text('مباشر', style: TExtra.label(c: CExtra.live, s: 10)),
                ] else if (match.isFinished)
                  Text('انتهت', style: TExtra.label(c: C.grey, s: 10))
                else
                  Text(match.matchTime, style: TExtra.label(c: C.gold, s: 10)),
              ])),
            const SizedBox(width: 8),
            ...
            if (match.channelHint.isNotEmpty)
              Container(padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
                ...
                child: Text(match.channelHint, style: TExtra.label(c: C.gold, s: 9))),
          ]),
          const SizedBox(height: 12),
          // Teams + Score
          Row(children: [
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                if (match.minuteDisplay.isNotEmpty)
                  Text(match.minuteDisplay,
                    style: TExtra.label(c: match.status == 'HT' ? C.gold : CExtra.live, s: 10)),
              ])),
            // فريق الضيف
            Expanded(child: Column(children: [
        ...
        child: Row(children: [
          ...
          Container(margin: const EdgeInsets.symmetric(horizontal: 10),
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              if (match.minuteDisplay.isNotEmpty)
                Text(match.minuteDisplay, style: TExtra.label(c: CExtra.live, s: 9)),
            ])),
