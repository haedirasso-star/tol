...
class _FirebaseLoginPageState extends State<FirebaseLoginPage>
  ...
  Future<void> _loadPosters() async {
    try {
      final r = await Dio().get('https://api.themoviedb.org/3/movie/popular',
  ...
  Future<void> _afterLogin(AuthResult res) async {
    ...
    if (uid != null) {
      // ★ FIX 1: ابدأ الاستماع لمستند المستخدم فوراً
      // يُحدِّث isAdmin + الاشتراك في الوقت الحقيقي بلا rebuild كامل
      AuthService.startUserDocListener(uid);

      // ★ FIX 2: استعادة الاشتراك من Firestore
      // يمنع معاملة المستخدم الموجود كمستخدم جديد
      await Sub.load();
            ...
            child: SlideTransition(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(children: [
                  ...
                  Text('منصة البث الذكية', style: T.cairo(s: 12, c: Colors.white54)),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Text('تصفح كضيف', style: T.cairo(s: 13, c: Colors.white38)),
                      ]),
                    ),
                  ),
                  const SizedBox(height: 6),
  ...
  Widget _chooseView() => Column(key: const ValueKey('choose'), crossAxisAlignment: CrossAxisAlignment.stretch, children: [
    Text('تسجيل الدخول', style: T.cairo(s: 20, w: FontWeight.w800), textAlign: TextAlign.center),
    const SizedBox(height: 24),
    // Google
    ...
    GestureDetector(
      ...
      child: Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(width: 8),
          Text(label, style: T.cairo(s: 14, w: FontWeight.w700, c: textColor)),
        ]),
      ),
    );
