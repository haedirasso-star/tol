...
class _FirebaseLoginPageState extends State<FirebaseLoginPage>
  ...
  Future<void> _afterLogin(AuthResult res) async {
    ...
    // ★ انتقل لشاشة حالة الحساب بدلاً من Shell مباشرة
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Icon(Icons.visibility_outlined, color: Colors.white.withOpacity(0.4), size: 17),
                        const SizedBox(width: 8),
                        Text('تصفح كضيف — بدون تسجيل',
                            style: T.cairo(s: FS.sm, c: Colors.white.withOpacity(0.4))),
                      ]),
                    ),
                  ),

                  const SizedBox(height: 6),
                  Text('الضيف يتصفح فقط • المشاهدة تتطلب حساباً',
