...
class _SocialBtn extends StatelessWidget {
  ...
  const _SocialBtn({required this.icon, required this.label, required this.bg,
      required this.fg, required this.onTap, required this.busy, this.autofocus = false});
    ...
    return _TVFocusable(
      ...
      builder: (focused) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(R.md),
          border: Border.all(
            color: focused ? C.gold : Colors.white.withOpacity(0.08),
...
// زر قابل للتركيز بالريموت (TV) — يبرز بإطار ذهبي عند التركيز
