...
class _AuthGateWidget extends StatelessWidget {
  ...
  Widget _buildUserCard(BuildContext ctx, User user) => Container(
    margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
    padding: const EdgeInsets.all(16),
    decoration: BoxDecoration(color: C.surface,
      border: Border.all(color: AuthService.isAdmin ? C.gold.withOpacity(.4) : CExtra.border),
      borderRadius: BorderRadius.circular(14)),
    child: Row(children: [
      ...
      if (AuthService.isAdmin)
        GestureDetector(
          ...
          child: Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 7),
            decoration: BoxDecoration(color: CC.goldBg, border: Border.all(color: C.gold.withOpacity(.3)),
