        ...
        SliverPadding(
          ...
          sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            if (!isPaid) ...[
              ...
              // تحقق من اشتراكك (إدخال يوزر+باسوورد للتفعيل المباشر)
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Container(width: 44, height: 44,
                      ...
                      child: const Center(child: Icon(Icons.verified_user_rounded, color: C.gold, size: 21))),
                    const SizedBox(width: 13),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('تحقق من اشتراكك', style: T.cairo(s: FS.md, w: FontWeight.w900)),
                      const SizedBox(height: 3),
                      Text('لديك اشتراك؟ أدخل اليوزر وكلمة المرور للتفعيل',
                          style: T.caption(c: CC.textSec)),
                    ])),
                    const Icon(Icons.chevron_left_rounded, color: C.gold, size: 20),
                  ])),
              ),
