      ...
      body: CustomScrollView(slivers: [
        ...
        SliverPadding(
          ...
          sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            _sectionLabel('سيرفر خاص'), const SizedBox(height: 8),
            _menuGroup([
              _menuRow(Icons.workspace_premium_rounded, 'اشتراك VIP',
                  'اتصل بسيرفرك الخاص (host / user / pass)',
            ...
            if (!isPaid) ...[
              ...
              // ★ زر "تفعيل اشتراكي" الأنيق (يظهر لغير المشتركين فقط ويختفي بعد التفعيل)
              GestureDetector(
                onTap: () { Sound.hapticM(); VipLoginSheet.show(context); },
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: C.gold.withOpacity(0.32), blurRadius: 18, offset: const Offset(0, 5))]),
                  child: Row(children: [
                    Container(width: 46, height: 46,
                      decoration: BoxDecoration(
                        color: Colors.black.withOpacity(0.16), shape: BoxShape.circle),
                      child: const Center(child: Icon(Icons.bolt_rounded, color: Colors.black, size: 24))),
                    const SizedBox(width: 13),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('تفعيل اشتراكي', style: T.cairo(s: FS.lg, w: FontWeight.w900, c: Colors.black)),
                      const SizedBox(height: 2),
                      Text('اكتب اليوزر وكلمة المرور — يتصل ويُفعّل فوراً',
                          style: T.cairo(s: FS.xs, w: FontWeight.w700, c: Colors.black.withOpacity(0.7))),
                    ])),
                    const Icon(Icons.chevron_left_rounded, color: Colors.black, size: 22),
                  ])),
              ),
              // خطط الاشتراك → بوابة الدفع الجديدة (PayPlansSheet)
