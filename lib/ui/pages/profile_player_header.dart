        ...
        SliverPadding(
          ...
          sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            if (isLogged) ...[ _sectionLabel('الحساب'), const SizedBox(height: 8),
              _menuGroup([
                _menuRow(Icons.person_outline_rounded, 'الملف الشخصي',
                    user.displayName ?? 'تعديل الاسم', () => _push(const _ProfileEditPage())),
            ...
            _menuGroup([
              ...
              if (isLogged)
                _menuRow(Icons.router_outlined, 'سيرفر مخصص',
                    SubCompat.isTOTV ? 'متصل ✓' : 'اتصال بسيرفر Xtream',
                    () => _push(const _TOTVServerPage())),
            ]),
            const SizedBox(height: 16),
            ...
            _menuGroup([
              ...
              _menuRow(Icons.bar_chart_rounded, 'إحصائياتي', 'سجل المشاهدة',
                  () => _push(const StatsPage())),
            ]),
            const SizedBox(height: 20),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        GestureDetector(
          onTap: () => _openUrl(RCCompat.settingsBuyUrl.isNotEmpty
              ? RCCompat.settingsBuyUrl : SubCompat.buyUrl),
