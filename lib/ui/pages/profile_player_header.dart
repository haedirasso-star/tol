    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const C.goldBg, const C.surface],
        ...
        FutureBuilder<Map<String, String>>(
          ...
          builder: (_, snap) {
            ...
            return Column(children: [
              ...
              const SizedBox(height: 8),
              Row(children: [
                _serverChip('الحالة', status, const C.green),
        ...
        child: Column(children: [
          ...
          Stack(children: [
            ...
            Container(height: 110, decoration: BoxDecoration(
              gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                colors: [Colors.black.withOpacity(0.5), const C.bg]))),
...
class _PaymentSheetState extends State<_PaymentSheet> {
  ...
  Widget _buildStep0() => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    Divider(color: Colors.white.withOpacity(0.07)),
    const SizedBox(height: 12),
    _mCard('website', '🌐', 'موقعنا الإلكتروني', 'اشترِ عبر موقعنا الرسمي', 'آمن 🔒', const C.green),
  ]);
  ...
  Widget _buildStep2() => Column(children: [
    ...
    Container(width: 72, height: 72,
      decoration: BoxDecoration(
        color: const C.green.withOpacity(0.1),
        shape: BoxShape.circle,
        border: Border.all(color: const C.green.withOpacity(0.5), width: 2)),
    ...
    GestureDetector(
      ...
      child: Container(height: 44,
        decoration: BoxDecoration(color: const C.whatsapp.withOpacity(0.07),
          borderRadius: BorderRadius.circular(R.md),
          border: Border.all(color: const C.whatsapp.withOpacity(0.25))),
        child: Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.support_agent_rounded, color: C.whatsapp, size: 16),
          const SizedBox(width: 8),
          Text('تواصل مع الدعم', style: T.cairo(s: FS.md, c: const C.whatsapp, w: FontWeight.w700)),
        ])))),
    const SizedBox(height: 8),
...
9. اللهجة العراقية مقبولة ومرحب بها''';
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      ).timeout(const Duration(seconds: FS.sm));
    ...
    child: Row(children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Text('متصل', style: T.caption(c: const C.green)),
        ]),
      ])),
      GestureDetector(
        onTap: () {
        ...
        child: Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(width: 4),
            Text('بشري', style: T.cairo(s: FS.sm, c: const C.whatsapp, w: FontWeight.w700)),
          ]))),
    ]));
