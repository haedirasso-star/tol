        ...
        Row(children: [
          ...
          Container(width: 52, height: 52,
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: C.gold.withOpacity(0.55), blurRadius: 14, spreadRadius: 1),
                BoxShadow(color: C.gold.withOpacity(0.25), blurRadius: 28, spreadRadius: 4),
              ]),
            child: ClipOval(child: Padding(
              ...
              child: Image.asset('assets/images/logo.png', fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => Container(
                  ...
                  child: const Icon(Icons.workspace_premium_rounded, color: C.gold, size: 24))))) ),
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Text('تم الاتصال بالسيرفر', style: T.caption(c: C.green)),
            ]),
          ])),
