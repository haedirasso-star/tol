      ...
      body: CustomScrollView(slivers: [
        ...
        SliverPadding(
          ...
          sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            // ── ★ المجتمع — الغرف الصوتية ──
            _sectionLabel('المجتمع'), const SizedBox(height: 8),
            _menuGroup([
              _menuRow(Icons.graphic_eq_rounded, 'الغرف الصوتية',
                  'تحدّث مع المشتركين مباشرة',
                  () => _push(const VoiceRoomsPage())),
              _menuRow(Icons.send_rounded, 'قناة تلجرام',
                  'أخبار الاشتراكات والتحديثات',
                  () => TgWelcome.openChannel()),
            ]),
            const SizedBox(height: 16),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Text('TOTV+', style: T.cairo(s: FS.lg, w: FontWeight.w900, c: C.gold)),
