...
class _SplashState extends State<Splash> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // 1) الشعار يظهر ويكبر ويستقرّ (0.04 → 0.30)
        ...
        builder: (_, __) => Opacity(
          ...
          child: Stack(children: [
            ...
            Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
              // ★ v2: شعار التطبيق الفعلي بدل النص — لحظة العلامة الأساسية
              Opacity(
                opacity: _tFade.value,
                child: Transform.scale(
                  scale: 0.90 + _tScale.value * 0.10,
                  child: Container(
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(
                          color: C.gold.withOpacity(0.30 * _glow.value),
                          blurRadius: 90 * _glow.value,
                    ...
                    child: Image.asset(
                      ...
                      // إن غاب الأصل لأي سبب، نعود للنص الذهبي القديم
